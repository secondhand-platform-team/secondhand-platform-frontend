...
const ICON_RULES: Rule[] = [
    {
        keywords: ["dien-thoai", "linh-kien", "thiet-bi-choi-game", "may-tinh", "dong-ho", "may-anh"],
        icon: "/icon-caterogy/device.png",
    },
    {
        keywords: ["quan-ao", "giay-dep", "tui-xach", "nuoc-hoa", "thoi-trang", "phu-kien"],
        icon: "/icon-caterogy/clothes.png",
    },
    {
        keywords: ["noi-that", "giuong", "chan-ga-goi-nem", "gia-dung", "quat", "tu-lanh", "may-lanh", "may-giat", "nha-bep", "nha-tam"],
    ...
    {
        keywords: ["dich-vu", "sua-chua", "bao-duong", "chuyen-nha", "don-dep"],
